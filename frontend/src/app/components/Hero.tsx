...
const Hero = ({ bgImage, isPreloaderDone }: { bgImage: string, isPreloaderDone: boolean }) => {
  return (
    ...
    >
      ...
      />
      <div className="container mx-auto flex flex-col gap-3 items-center px-4 py-16 text-center z-10 relative">
        <p className="uppercase text-sm font-semibold text-white leading-none">
        ...
        <div className="text-white text-9xl font-semibold flex flex-col items-center">
          ...
          <div className="flex items-center gap-1 overflow-hidden pb-4">
            <motion.h1
              initial={{ y: "100%" }}
              animate={isPreloaderDone ? { y: 0 } : { y: "100%" }}
            ...
            <img
              src={bgImage}
              alt=""
              className="hero-expand-img rounded-2xl object-cover object-center"
            />
            <motion.h1
              initial={{ y: "100%" }}
              animate={isPreloaderDone ? { y: 0 } : { y: "100%" }}
        ...
        <div>
          <div className="flex flex-row items-center justify-center gap-8 mt-8 flex-wrap">
            <div>
